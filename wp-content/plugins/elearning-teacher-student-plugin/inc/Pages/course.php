            ...
            if ( $wpdb->num_rows ) {
                ...
                foreach ($items as $item) {
                    if (!in_array($item->id,$doneunits)){
                        ...
                        $string .= '<td class="lefttitle" onclick="location.href=\'' . get_home_url() . '/user-unit?unitid=' . $item->id . '&unitname=' . $item->name . '&courseid=' . $courseid . '\'">' . $item->name . '</td><td class="rightaction">
                        <div class="startcourse" onclick="location.href=\'user-unit?unitid=' . $item->id . '&unitname=' . $item->name . '&courseid=' . $courseid . '\'"></div>
                    </td>';
                        $string .= '</tr>';
                    }else{
                        $string .= '<tr id="trofulcomponents">';
